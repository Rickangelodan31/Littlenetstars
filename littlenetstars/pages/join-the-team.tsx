...
export default function JoinTheTeam() {
  return (
    <>
      <Head>
        <title>Join the Team – LittleNetStars</title>
        <meta name="description" content="Join the LittleNetStars coaching team." />
      </Head>
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            >
              ...
              <p className="mt-6 text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
                Interested in coaching with LittleNetStars? We&apos;re always looking for passionate coaches to join our team.
              </p>
              <p className="mt-4 text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
                Get in touch to find out about current opportunities.
              </p>
              <p className="mt-6 text-lg font-semibold text-purple-600 dark:text-purple-400">
